...
// "Believe the receipt, never the payload", in the ONE module both writers of
// fields.review_status call — this file and app/api/admin/timesheet/route.js.
// See lib/aws/ai-fields.js for why a second copy would be the looser one.
import { aiFieldsFrom } from "./ai-fields.js";
  ...
  try {
    ...
    const cleanValues = (obj) => {
      ...
      if (table === "ts_employee_edits" && "fields" in (obj || {})) {
        ...
        Object.assign(fieldsOut, aiFieldsFrom(aiVerdict, src));
